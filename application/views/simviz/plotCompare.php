  ...
  $(function () {
    ...
    $(document).ready(function() {
      ...
      var options1 =({
            ...
            title: {
                text: 'TestBench <?= $simulation->simTestBenchID; ?> / Configuration:  / Plot Version #<?= $plot->PlotVersion; ?>',
                x: -20 // center
            },
            xAxis: {
                title: {text: 'Milliseconds', margin: 15},
...
$(".yaxisvar").live("click", function()
{
      ...
      else
      {
        ...
        {
          console.log("series name: "+ series1[i].name);
          if (series1[i].name == seriesShortName)
          {
            chart1.series[i].remove(true);
            break;
          }
        }
